  ...
  return (
    <div className="relative w-full overflow-hidden">
      <div className="flex flex-col md:flex-row">
        {/* Text Section */}
        <div 
          className={`w-full md:w-1/2 py-16 flex flex-col justify-center ${isImageRight ? '' : 'order-2'}`}
        ...
        {/* Image Section */}
        <div className={`w-full md:w-1/2 min-h-[500px] relative ${isImageRight ? '' : 'order-1'}`}>
          <img
            src="/imgphehchan.png"
            alt={imageAlt}
